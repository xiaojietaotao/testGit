...
public:
    ...
    void setupUi(QDialog *workdata_tuitu)
    {
        if (workdata_tuitu->objectName().isEmpty())
            workdata_tuitu->setObjectName(QString::fromUtf8("workdata_tuitu"));
    ...
    {
        workdata_tuitu->setWindowTitle(QCoreApplication::translate("workdata_tuitu", "Dialog", nullptr));
        label_67->setText(QCoreApplication::translate("workdata_tuitu", "\346\226\275\345\267\245\344\275\234\344\270\232\346\225\260\346\215\256", nullptr));
    } // retranslateUi
